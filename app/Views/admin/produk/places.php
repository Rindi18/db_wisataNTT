...
<section id="places">
        <h2>Tempat Wisata di NTT yang Indah Penuh Pesona</h2>
        <ul>
            <li>
                <img src="<?= base_url('asset-admin'); ?>/img/sejarah-pantai-pink-lombok-780x470.jpg" alt="Pantai Pink" width="9065" height="301">
                <h3>1.Pantai Pink</h3>
                <p>Pantai Pink merupakan pantai dengan pasir putih yang berwarna kemerah-merahan karena perpaduan antara warna putih dengan warna merah sehingga pasir di pantai Pink mirip dengan warna merah muda (Pink), sebab itulah pantai ini dinamakan pantai Pink.
                    Ada beberapa alasan wisatawan lebih memilih pantai Pink sebagai tempat wisata bahari di pulau Lombok, alasan utama wisatawan berkunjung ke pantai Pink untuk melihat keindahan pasir pantai Pink yang berwarna mirip dengan warna merah muda (pink). Warna pasir di pantai yang satu ini memang beda dengan warna pasir di pantai lain di pulau Lombok, sehingga salah satu kelainan inilah yang menjadi kelebihan dari pantai yang satu ini dalam memikat wisatawan untuk berkunjung. Warna pink pada pasir pantai ini sangat bervariasi, pagi hari 20-30%, siang hari 50% dan semakin sore, warnanya pun akan terlihat jelas, antara 80-90 %. Wah sungguh sangat menawan.
                    Alasan selanjutnya adalah laut di pantai Pink masih jernih sehingga saat naik sampan dapat melihat keindahan bawah laut dari atas permukaan air laut. Bagi kamu yang suka mandi air laut, disini juga salah satu tempat yang menarik untuk main air laut di pesisir pantai, apalagi bagi yang suka mandi air laut.
</p>
            </li>
            <li>
                <img src="<?= base_url('asset-admin'); ?>/img/komodo1.jpeg" alt="Pulau Komodo" width="400" height="300">
                <h3>2.Pulau Komodo</h3>
                <p>Pulau Komodo adalah sebuah pulau yang terletak di Kepulauan Nusa Tenggara, berada di sebelah timur Pulau Sumbawa, yang dipisahkan oleh Selat Sape. Pulau Komodo dikenal sebagai habitat asli hewan komodo.
            ...
            <li>
                <img src="<?= base_url('asset-admin'); ?>/img/pantai-nemberala-profile1638944140.jpeg" alt="pantai nemberala" width="500" height="350">
                <h3>7.Pantai nemberala</h3>
                <p>Pantai Nembrala yang terletak di Desa Nembrala, Kecamatan Rote Barat, Kabupaten Rote Ndao, Nusa Tenggara Timur. Selain memiliki pantai dan pasir putih yang indah, gulungan ombak Pantai Nembrala juga sudah mendunia. Karena itulah, setiap musim ombak (bulan Agustus-Oktober) tiba di Pantai Nembrala dan Bo’a biasanya diadakan event olah raga surfing baik regional maupun berkelas internasional. Pada waktu tersebut, Pantai Nembrala akan terlihat sangat ramai sekali oleh para peselancar dari berbagai negara yang hendak mencoba menantang gulungan ombaknya yang terkenal itu. Pantai Nembrala juga sangat terkenal sebagai penghasil rumput laut terbesar di Pulau Rote Ndao. Saat menjelang sore haripun, pengunjung juga dapat menyaksikan keindahan momen matahari tenggelam sambil melihat aktivitas para petani rumput laut yang semakin menambah keelokan Pantai Nembrala.</p>
            </li>
        </ul>
    </section
    <p> &copy; 2024 Alam NTT by Sri Meiriani</p>
</footer>
</body>
</html>   
